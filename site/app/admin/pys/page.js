...
export const metadata = { title: "Yoga Sutras — Admin", robots: "noindex, nofollow" };

export default async function PYSAdminPage() {
    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", fontFamily: "'Source Sans 3','Segoe UI',system-ui,sans-serif", background: "#F0F2F5", color: "#1C1917" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        <div style={{ background: "#fff", borderBottom: "1px solid #E5E7EB", padding: "0 28px", height: 56, display: "flex", alignItems: "center", position: "sticky", top: 0, zIndex: 10 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: "#0F1A2E" }}>🧘 Yoga Sutras of Patanjali — JSON Content Editor</div>
          <span style={{ marginLeft: 12, fontSize: 12, color: "#9CA3AF" }}>4 Padas · 196 Sutras</span>
        </div>
